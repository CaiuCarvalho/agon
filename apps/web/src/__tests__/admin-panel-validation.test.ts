...
describe('Admin Panel - Database Migrations', () => {
  ...
  it('should have shipping fields migration', () => {
    const path = join(migrationsPath, '20260405000011_admin_panel_shipping_fields.sql');
  ...
  it('should have webhook RPC update migration', () => {
    const path = join(migrationsPath, '20260405000013_update_webhook_rpc_atomic.sql');
  ...
  it('should have RLS policies migration', () => {
    const path = join(migrationsPath, '20260405000012_admin_panel_rls_policies.sql');
