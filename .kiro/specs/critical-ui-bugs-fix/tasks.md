...
- [ ] 1.2 Write preservation property tests (ANTES de implementar correção)
...
- [ ] 1.3 Fix para redirecionamento baseado em autenticação

  - [ ] 1.3.1 Implementar verificação de autenticação no botão
  ...
  - [ ] 1.3.2 Verificar que bug condition exploration test agora passa
  ...
  - [ ] 1.3.3 Verificar que preservation tests ainda passam
    - **Property 2: Preservation** - Navegação para Usuários Não Autenticados
...
- [ ] 1.4 Checkpoint - Garantir que todos os testes do Bug 1 passam
...
- [ ] 2.2 Write preservation property tests (ANTES de implementar correção)
...
- [ ] 2.3 Fix para tratamento robusto de erro RPC

  - [ ] 2.3.1 Implementar detecção de erro RPC não existente
  ...
  - [ ] 2.3.2 Implementar validação de resposta RPC
  ...
  - [ ] 2.3.3 Implementar fallback para insert direto
  ...
  - [ ] 2.3.4 Verificar que bug condition exploration test agora passa
  ...
  - [ ] 2.3.5 Verificar que preservation tests ainda passam
    - **Property 2: Preservation** - Operações de Carrinho Existentes
...
- [ ] 2.4 Checkpoint - Garantir que todos os testes do Bug 2 passam
...
- [ ] 3.2 Write preservation property tests (ANTES de implementar correção)
...
- [ ] 3.3 Fix para timeout e finally block no histórico

  - [ ] 3.3.1 Implementar AbortController com timeout de 10 segundos
  ...
  - [ ] 3.3.2 Adicionar finally block para resetar loading
  ...
  - [ ] 3.3.3 Melhorar mensagens de erro específicas
  ...
  - [ ] 3.3.4 Implementar estado vazio apropriado
  ...
  - [ ] 3.3.5 Verificar que bug condition exploration test agora passa
  ...
  - [ ] 3.3.6 Verificar que preservation tests ainda passam
    - **Property 2: Preservation** - Outras Operações de Pedidos
...
- [ ] 3.4 Checkpoint - Garantir que todos os testes do Bug 3 passam
...
- [ ] 4.2 Write preservation property tests (ANTES de implementar correção)
...
- [ ] 4.3 Fix para timeout e finally block no endereço

  - [ ] 4.3.1 Implementar AbortController com timeout de 10 segundos
  ...
  - [ ] 4.3.2 Adicionar finally block para resetar submitting
  ...
  - [ ] 4.3.3 Melhorar mensagens de erro específicas
    - No catch block, verificar `error.name === 'AbortError'` para timeout
  ...
  - [ ] 4.3.4 Aplicar mesmo fix em handleUpdate
  ...
  - [ ] 4.3.5 Verificar que bug condition exploration test agora passa
  ...
  - [ ] 4.3.6 Verificar que preservation tests ainda passam
    - **Property 2: Preservation** - Outras Operações de Endereço
...
- [ ] 4.4 Checkpoint - Garantir que todos os testes do Bug 4 passam
